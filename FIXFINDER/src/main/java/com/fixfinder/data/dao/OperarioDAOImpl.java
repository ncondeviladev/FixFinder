...
public class OperarioDAOImpl implements OperarioDAO {
    ...
    public void insertar(Operario operario) throws DataAccessException {
        ...
        // 1. Insertar en 'usuario' (Datos comunes + DNI + campos nuevos)
        String sqlUsuario = "INSERT INTO usuario (email, password_hash, nombre_completo, rol, dni, telefono, direccion, url_foto) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            try (PreparedStatement stmtUser = conn.prepareStatement(sqlUsuario, Statement.RETURN_GENERATED_KEYS)) {
                ...
                stmtUser.setString(5, operario.getDni());
                stmtUser.setString(6, operario.getTelefono());
                stmtUser.setString(7, operario.getDireccion());
                stmtUser.setString(8, operario.getUrlFoto());
    ...
    public void actualizar(Operario operario) throws DataAccessException {
        ...
        String sqlUsuario = "UPDATE usuario SET email=?, nombre_completo=?, password_hash=?, dni=?, telefono=?, direccion=?, url_foto=? WHERE id=?";
        ...
        try {
            ...
            try (PreparedStatement stmtUser = conn.prepareStatement(sqlUsuario)) {
                ...
                stmtUser.setString(5, operario.getTelefono());
                stmtUser.setString(6, operario.getDireccion());
                stmtUser.setString(7, operario.getUrlFoto());
                stmtUser.setInt(8, operario.getId());
    ...
    private Operario mapearOperario(ResultSet rs) throws SQLException {
        ...
        o.setUrlFoto(rs.getString("url_foto"));
        try {
