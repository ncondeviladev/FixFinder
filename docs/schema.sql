...
CREATE TABLE usuario (
    ...
    rol ENUM('ADMIN', 'GERENTE', 'OPERARIO', 'CLIENTE') NOT NULL,
...
CREATE TABLE operario (
    ...
    especialidad VARCHAR(50), -- Ej: Plomero, Electricista
    estado ENUM('DISPONIBLE', 'OCUPADO', 'BAJA') DEFAULT 'DISPONIBLE',
    latitud DOUBLE,
    longitud DOUBLE,
...
-- 4. Categorías de Trabajos
CREATE TABLE categoria (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nombre VARCHAR(50) NOT NULL, -- Ej: Fontanería, Electricidad
    descripcion TEXT,
    precio_hora_base DECIMAL(10, 2) DEFAULT 0.00
);
...
CREATE TABLE trabajo (
    ...
    latitud DOUBLE,
    longitud DOUBLE,
    estado ENUM('PENDIENTE', 'ASIGNADO', 'EN_PROCESO', 'FINALIZADO', 'CANCELADO') DEFAULT 'PENDIENTE',
...
INSERT INTO empresa (nombre, cif) VALUES ('Reparaciones Express S.L.', 'B12345678');
-- La contraseña sería un hash real en producción
INSERT INTO usuario (id_empresa, email, password_hash, nombre_completo, rol) VALUES 
(1, 'admin@express.com', 'hash123', 'Admin Sistema', 'ADMIN'),
(1, 'pepe@express.com', 'hash123', 'Pepe Gotera', 'OPERARIO');

INSERT INTO operario (id_usuario, dni, especialidad) VALUES 
(2, '12345678Z', 'Fontanería');
