...
Hemos elegido el siguiente stack por productividad:

- **Java + Sockets + MySQL**: Garantiza robustez, control en tiempo real y la fiabilidad de una base de datos relacional para la facturación.
- **JavaFX**: Permite crear interfaces de escritorio modernas reutilizando la lógica Java del servidor.
- **Flutter**: Facilita crear una sola app visualmente atractiva ("Premium") que funcione en Android y iPhone con un solo desarrollo, ahorrando tiempo.
...
- **Seguridad**:
  - Almacenamiento seguro de contraseñas mediante algoritmos de Hashing (SHA-256/BCrypt).
